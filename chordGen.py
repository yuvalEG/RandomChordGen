...
def random_simple_chord():
    ...
    return SimpleChordNames[random_simple_chord_number] \
...
# I placed the empty string in SeptaChordSigns in order to generate non-septachords, it's not best practice
...
def random_chord():
    ...
    output = Used_ChordNames[random_chord_name_selected] \
